...
<a name="method_{$methods[methods].function_name}" id="method_{$methods[methods].function_name}"><!-- --></a>
<div class="{cycle values="evenrow,oddrow"}">
	
	<div class="method-header">
		<img src="{$subdir}images/StaticMethod.png" />
...
<div class="{cycle values="evenrow,oddrow"}">
	...
	<div class="method-header">
		<img src="{$subdir}images/{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{else}{if $methods[methods].abstract}Abstract{/if}{if $methods[methods].access == 'private'}Private{/if}Method{/if}.png" />
