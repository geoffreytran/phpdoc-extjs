...
<a name="const_{$consts[consts].const_name}" id="const_{$consts[consts].const_name}"><!-- --></A>
<div class="{cycle values="evenrow,oddrow"}">

	<div class="const-header">
		<img src="{$subdir}images/{if $consts[consts].access == 'private'}PrivateVariable{else}Variable{/if}.png" />
